...
void MixColumns(u8* temp)
{
	...
	for (i = 0; i < 16; i += 4) {
		temp[i]     = mul2(r[i]) ^ mul3(r[i + 1]) ^ r[i + 2] ^ r[i + 3];
		temp[i + 1] = r[i] ^ mul2(r[i + 1]) ^ mul3(r[i + 2]) ^ r[i + 3];
		temp[i + 2] = r[i] ^ r[i + 1] ^ mul2(r[i + 2]) ^ mul3(r[i + 3]);
		temp[i + 3] = mul3(r[i]) ^ r[i + 1] ^ r[i + 2] ^ mul2(r[i + 3]);
	}
...
void RoundkeyGeneration128_Optimization(u8* MK, u32* W, int keysize)
{
	u32 i, T;
...
void AES_ENC_Optimization(u8 *in, u8 *out, u32 *W, int keysize)
{
	int Nr = keysize / 32 + 6;
	int i;
	...
	s0 = u4byte_in(in) ^ W[0];
	s1 = u4byte_in(in + 4) ^ W[1];
	s2 = u4byte_in(in + 8) ^ W[2];
	s3 = u4byte_in(in + 16) ^ W[3];
	// Round 1
	t0 = Te0[s0 >> 24] ^ Te1[(s1 >> 16) & 0xff] ^ Te2[(s2 >> 8) & 0xff] ^ Te0[s3 & 0xff] ^ W[4];
	t1 = Te0[s1 >> 24] ^ Te1[(s2 >> 16) & 0xff] ^ Te2[(s3 >> 8) & 0xff] ^ Te0[s0 & 0xff] ^ W[5];
	t2 = Te0[s2 >> 24] ^ Te1[(s3 >> 16) & 0xff] ^ Te2[(s0 >> 8) & 0xff] ^ Te0[s1 & 0xff] ^ W[6];
	t3 = Te0[s3 >> 24] ^ Te1[(s0 >> 16) & 0xff] ^ Te2[(s1 >> 8) & 0xff] ^ Te0[s2 & 0xff] ^ W[7];
	// Round 2
	s0 = Te0[t0 >> 24] ^ Te1[(t1 >> 16) & 0xff] ^ Te2[(t2 >> 8) & 0xff] ^ Te0[t3 & 0xff] ^ W[8];
	s1 = Te0[t1 >> 24] ^ Te1[(t2 >> 16) & 0xff] ^ Te2[(t3 >> 8) & 0xff] ^ Te0[t0 & 0xff] ^ W[9];
	s2 = Te0[t2 >> 24] ^ Te1[(t3 >> 16) & 0xff] ^ Te2[(t0 >> 8) & 0xff] ^ Te0[t1 & 0xff] ^ W[10];
	s3 = Te0[t3 >> 24] ^ Te1[(t0 >> 16) & 0xff] ^ Te2[(t1 >> 8) & 0xff] ^ Te0[t2 & 0xff] ^ W[11];
	// Round 3
	t0 = Te0[s0 >> 24] ^ Te1[(s1 >> 16) & 0xff] ^ Te2[(s2 >> 8) & 0xff] ^ Te0[s3 & 0xff] ^ W[12];
	t1 = Te0[s1 >> 24] ^ Te1[(s2 >> 16) & 0xff] ^ Te2[(s3 >> 8) & 0xff] ^ Te0[s0 & 0xff] ^ W[13];
	t2 = Te0[s2 >> 24] ^ Te1[(s3 >> 16) & 0xff] ^ Te2[(s0 >> 8) & 0xff] ^ Te0[s1 & 0xff] ^ W[14];
	t3 = Te0[s3 >> 24] ^ Te1[(s0 >> 16) & 0xff] ^ Te2[(s1 >> 8) & 0xff] ^ Te0[s2 & 0xff] ^ W[15];
	// Round 4
	s0 = Te0[t0 >> 24] ^ Te1[(t1 >> 16) & 0xff] ^ Te2[(t2 >> 8) & 0xff] ^ Te0[t3 & 0xff] ^ W[16];
	s1 = Te0[t1 >> 24] ^ Te1[(t2 >> 16) & 0xff] ^ Te2[(t3 >> 8) & 0xff] ^ Te0[t0 & 0xff] ^ W[17];
	s2 = Te0[t2 >> 24] ^ Te1[(t3 >> 16) & 0xff] ^ Te2[(t0 >> 8) & 0xff] ^ Te0[t1 & 0xff] ^ W[18];
	s3 = Te0[t3 >> 24] ^ Te1[(t0 >> 16) & 0xff] ^ Te2[(t1 >> 8) & 0xff] ^ Te0[t2 & 0xff] ^ W[19];
	// Round 5
	t0 = Te0[s0 >> 24] ^ Te1[(s1 >> 16) & 0xff] ^ Te2[(s2 >> 8) & 0xff] ^ Te0[s3 & 0xff] ^ W[20];
	t1 = Te0[s1 >> 24] ^ Te1[(s2 >> 16) & 0xff] ^ Te2[(s3 >> 8) & 0xff] ^ Te0[s0 & 0xff] ^ W[21];
	t2 = Te0[s2 >> 24] ^ Te1[(s3 >> 16) & 0xff] ^ Te2[(s0 >> 8) & 0xff] ^ Te0[s1 & 0xff] ^ W[22];
	t3 = Te0[s3 >> 24] ^ Te1[(s0 >> 16) & 0xff] ^ Te2[(s1 >> 8) & 0xff] ^ Te0[s2 & 0xff] ^ W[23];
	// Round 6
	s0 = Te0[t0 >> 24] ^ Te1[(t1 >> 16) & 0xff] ^ Te2[(t2 >> 8) & 0xff] ^ Te0[t3 & 0xff] ^ W[24];
	s1 = Te0[t1 >> 24] ^ Te1[(t2 >> 16) & 0xff] ^ Te2[(t3 >> 8) & 0xff] ^ Te0[t0 & 0xff] ^ W[25];
	s2 = Te0[t2 >> 24] ^ Te1[(t3 >> 16) & 0xff] ^ Te2[(t0 >> 8) & 0xff] ^ Te0[t1 & 0xff] ^ W[26];
	s3 = Te0[t3 >> 24] ^ Te1[(t0 >> 16) & 0xff] ^ Te2[(t1 >> 8) & 0xff] ^ Te0[t2 & 0xff] ^ W[27];
	// Round 7
	t0 = Te0[s0 >> 24] ^ Te1[(s1 >> 16) & 0xff] ^ Te2[(s2 >> 8) & 0xff] ^ Te0[s3 & 0xff] ^ W[28];
	t1 = Te0[s1 >> 24] ^ Te1[(s2 >> 16) & 0xff] ^ Te2[(s3 >> 8) & 0xff] ^ Te0[s0 & 0xff] ^ W[29];
	t2 = Te0[s2 >> 24] ^ Te1[(s3 >> 16) & 0xff] ^ Te2[(s0 >> 8) & 0xff] ^ Te0[s1 & 0xff] ^ W[30];
	t3 = Te0[s3 >> 24] ^ Te1[(s0 >> 16) & 0xff] ^ Te2[(s1 >> 8) & 0xff] ^ Te0[s2 & 0xff] ^ W[31];
	// Round 8
	s0 = Te0[t0 >> 24] ^ Te1[(t1 >> 16) & 0xff] ^ Te2[(t2 >> 8) & 0xff] ^ Te0[t3 & 0xff] ^ W[32];
	s1 = Te0[t1 >> 24] ^ Te1[(t2 >> 16) & 0xff] ^ Te2[(t3 >> 8) & 0xff] ^ Te0[t0 & 0xff] ^ W[33];
	s2 = Te0[t2 >> 24] ^ Te1[(t3 >> 16) & 0xff] ^ Te2[(t0 >> 8) & 0xff] ^ Te0[t1 & 0xff] ^ W[34];
	s3 = Te0[t3 >> 24] ^ Te1[(t0 >> 16) & 0xff] ^ Te2[(t1 >> 8) & 0xff] ^ Te0[t2 & 0xff] ^ W[35];

	if(keysize >= 128) {
	// Round 9
	t0 = Te0[s0 >> 24] ^ Te1[(s1 >> 16) & 0xff] ^ Te2[(s2 >> 8) & 0xff] ^ Te0[s3 & 0xff] ^ W[36];
	t1 = Te0[s1 >> 24] ^ Te1[(s2 >> 16) & 0xff] ^ Te2[(s3 >> 8) & 0xff] ^ Te0[s0 & 0xff] ^ W[37];
	t2 = Te0[s2 >> 24] ^ Te1[(s3 >> 16) & 0xff] ^ Te2[(s0 >> 8) & 0xff] ^ Te0[s1 & 0xff] ^ W[38];
	t3 = Te0[s3 >> 24] ^ Te1[(s0 >> 16) & 0xff] ^ Te2[(s1 >> 8) & 0xff] ^ Te0[s2 & 0xff] ^ W[39];
	// Round 10
	s0 = (Te0[t0 >> 24] & 0xff000000) ^ (Te1[(t1 >> 16) & 0xff] & 0x00ff0000) ^ (Te2[(t2 >> 8) & 0xff] & 0x0000ff00) ^ (Te0[t3 & 0xff] ^ W[40] & 0xff);
	s1 = (Te0[t1 >> 24] & 0xff000000) ^ (Te1[(t2 >> 16) & 0xff] & 0x00ff0000) ^ (Te2[(t3 >> 8) & 0xff] & 0x0000ff00) ^ (Te0[t0 & 0xff] ^ W[41] & 0xff);
	s2 = (Te0[t2 >> 24] & 0xff000000) ^ (Te1[(t3 >> 16) & 0xff] & 0x00ff0000) ^ (Te2[(t0 >> 8) & 0xff] & 0x0000ff00) ^ (Te0[t1 & 0xff] ^ W[42] & 0xff);
	s3 = (Te0[t3 >> 24] & 0xff000000) ^ (Te1[(t0 >> 16) & 0xff] & 0x00ff0000) ^ (Te2[(t1 >> 8) & 0xff] & 0x0000ff00) ^ (Te0[t2 & 0xff] ^ W[43] & 0xff);
	}
	else if(keysize == 192) {
...
int main() {
	...
	u8      RK[240] = {0, };
	u32     W[60];
	u8      in[160] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
	u8      out[160] = { 0x00, };
	u32     keysize, i;
...
*/
	...
	start = clock();    // start
	RoundkeyGeneration128_Optimization(MK, W, keysize);
    AES_ENC_Optimization(in, out, W, keysize);
	finish = clock();
